...
*   **Contexto del Error:** ℹ️ Asegurarse de que la información enviada al `webhook` contenga suficiente contexto para diagnosticar el problema sin necesidad de consultar logs adicionales.
